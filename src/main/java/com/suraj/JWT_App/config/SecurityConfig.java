...
import com.suraj.JWT_App.filter.JwtFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtFilter jwtFilter, PasswordEncoder passwordEncoder, UserDetailsService userDetailsService) {
